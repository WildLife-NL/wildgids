...
class _ChallengeScreenState extends State<ChallengeScreen> {
  ...
  void _onTabSelected(NavTab tab) {
    if (tab == NavTab.ontdekken || tab == NavTab.zones) return;
            ...
            GestureDetector(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: ChallengeScreen.primaryGreen.withValues(alpha: 0.3),
                      blurRadius: 14,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: ChallengeScreen.primaryGreen.withValues(alpha: 0.25),
            blurRadius: 20,
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: _isHovered
                ? ChallengeScreen.primaryGreen.withValues(alpha: 0.25)
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: _isHovered
                ? ChallengeScreen.primaryGreen.withValues(alpha: 0.2)
                : Colors.grey.shade200,
            width: 1.5,
          ),
          boxShadow: [
